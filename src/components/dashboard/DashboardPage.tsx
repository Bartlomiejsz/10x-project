            ...
            <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 p-4 sm:p-6">
                ...
                <header className="sticky top-0 z-10 -mx-4 bg-slate-50 px-4 py-4 sm:-mx-6 sm:px-6">
                    <div className="mb-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <p className="text-sm font-medium text-slate-500">Dashboard budżetu</p>
                            {readonly.isReadonly && (
                                <span className="mt-1 inline-flex items-center gap-1 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-medium text-amber-900">
                                    Tylko podgląd
                                </span>
                            )}
                            {isLoadingAggregates && (
                                <span className="mt-2 block text-xs text-slate-500" aria-live="polite">
                                    Odświeżanie podsumowań…
                                </span>
                            )}
                        </div>
                    </div>
